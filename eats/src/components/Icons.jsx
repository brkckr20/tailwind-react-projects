...
const TruckIcon = ({ size }) => {
    return (
        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 640 512" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
...
const HearthIcon = ({ size }) => {
    return (
        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 521 512" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
...
const TagIcon = ({ size }) => {
    return (
        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
